		...
		<article class="item">
			...
			<?php if ($params->get('show_publish_date')) : ?>
				<time datetime="<?php echo JHtml::_('date', $item->publish_up, 'Y-m-d H:i'); ?>" class="item_published">
					<?php echo JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_TPL2')); ?>/<?php echo JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_TPL3')); ?>
				</time>
			<?php endif;
			...
			<?php $useDefList = (($params->get('show_author') && !empty($item->author )) || $params->get('show_modify_date') || $params->get('show_hits') || $params->get('show_category') || $params->get('show_parent_category') || $params->get('show_create_date'));
