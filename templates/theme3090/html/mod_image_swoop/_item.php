...
<div class="camera-item" data-src="<?php echo JURI::base().htmlspecialchars($images->image_fulltext); ?>"<?php if($images->image_intro!=''): ?> data-thumb="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>"<?php endif; ?><?php if($itemUrl!=''): ?> data-link="<?php echo $itemUrl; ?>" data-target="<?php echo '_'.$params->get('target'); ?>"<?php endif; ?>>
			...
			<?php if ($params->get('item_title')) : ?>
				...
				<?php if ($params->get('link_titles') && $item->link != '') : ?>
					<a href="<?php echo $item->link;?>">
						<?php echo wrap_with_span($item->title); ?></a>
				<?php else : ?>
